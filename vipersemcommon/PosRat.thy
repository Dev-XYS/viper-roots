...
lemma pinv_inverts:
  ...
  by (metis (mono_tags, lifting) Abs_prat_inverse assms(1,2) divide_prat.rep_eq divide_rat_def inverse_prat_def le_imp_inverse_le mem_Collect_eq mult_1 one_prat.abs_eq pgte.rep_eq ppos.rep_eq zero_le_one)
