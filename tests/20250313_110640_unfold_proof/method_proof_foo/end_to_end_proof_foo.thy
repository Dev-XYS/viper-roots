...
apply ((rule end_to_end_vpr_method_correct_partial[where ?ctxt = ctxt_bpl, OF assms mono_prop_downward_ord_consistent_internal_total_full wf_ty_repr_basic wf_total_consistency_internal[OF CtxtPredWf CtxtPredSelfFraming]]))
