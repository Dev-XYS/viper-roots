...
shows "(list_all (comp (vpr_method_correct_total_partial (global_data_end_to_end.ctxt_vpr::(('a) total_context)) (\<lambda> _.True)) snd) [(''foo'',method_decls.foo_decl)])"
apply (simp)
apply (((intro conjI))?)
...
shows "(vpr_method_correct_total_partial (global_data_end_to_end.ctxt_vpr::(('a) total_context)) (\<lambda> _.True) mdecl)"
...
"(proc_is_correct (type_interp_bpl (absval_interp_total global_data_end_to_end.ctxt_vpr)) global_data.fdecls global_data.constants_vdecls global_data.unique_consts global_data.globals_vdecls global_data.axioms foo_before_ast_to_cfg_prog.ast_proc (Ast.proc_body_satisfies_spec::(((('a) vbpl_absval), ast) proc_body_satisfies_spec_ty)))"
shows "(vpr_method_correct_total (global_data_end_to_end.ctxt_vpr::(('a) total_context)) (\<lambda> _.True) mdecl)"
