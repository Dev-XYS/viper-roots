...
*)
  ...
  fun inhale_rel_field_acc_upd_rel_tac ctxt (info: basic_stmt_rel_info) exp_rel_info =
    ...
    (Rmsg' "inh field acc upd MaskUpdateWf" (resolve_tac ctxt [ @{thm mask_update_wf_concrete} OF [#ctxt_wf_thm info, #wf_ty_repr_thm info]] THEN'
                                             assm_full_simp_solved_tac ctxt) ctxt) THEN'
    (Rmsg' "inh field acc upd MaskReadWf" (resolve_tac ctxt [ @{thm mask_read_wf_concrete} OF [#ctxt_wf_thm info, #wf_ty_repr_thm info]] THEN'
                                           assm_full_simp_solved_tac ctxt) ctxt) THEN'
