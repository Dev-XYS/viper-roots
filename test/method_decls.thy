...
definition foo_body :: "((stmt) option)" where 
  "foo_body  = (Some (Inhale (Atomic (AccPredicate ''P'' [(ViperLang.Var 0)] (PureExp (ELit WritePerm))))))"
...
shows "((method_decl.body foo_decl)=(Some (Inhale (Atomic (AccPredicate ''P'' [(ViperLang.Var 0)] (PureExp (ELit WritePerm)))))))"
